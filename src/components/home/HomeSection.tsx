  ...
  return (
    <div className="flex w-full h-screen mx-auto overflow-hidden">
      ...
      <div className="flex-1 flex flex-col w-[50%] items-center bg-darak-bg justify-center gap-6">
        ...
        <div className="flex justify-center items-center w-[500px] h-[261px] relative gap-2.5 p-[22px] rounded-[20px] bg-[#979797]/20">
          <p className="flex-grow-0 flex-shrink-0 w-[450px] text-base text-left">
            <span className="flex-grow-0 flex-shrink-0 w-[450px] text-base font-light text-left text-[#373737]">
            ...
            <span className="flex-grow-0 flex-shrink-0 w-[450px] text-base text-left text-[#6b4f3b]">
              ‘다락방'
            </span>
            <span className="flex-grow-0 flex-shrink-0 w-[450px] text-base font-light text-left text-[#373737]">
      ...
      {/* 우측 */}
      <div className="flex-1 flex flex-col w-[50%] items-center justify-center bg-darak-bg-dark gap-6 relative">
