...
export default function EntranceConfirmDialog({
  open,
  onConfirm,
}: {
  open: boolean;
  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
      <div className="bg-[#FAF5F1] rounded-[10px] w-[734px] h-[408px] py-[98px] flex-col justify-center items-center gap-[10px]">
        <Image
          src="/img/darak.svg"
          alt="darak"
          width={85.7}
